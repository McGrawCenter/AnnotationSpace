...
// functions for annotationspace functionality
function annotationspace_content_filter($content) {
  $content = preg_replace_callback("/<a href=\"(.*?)\"/i","annotationspace_add_refs", $content);
  return $content;
}

add_filter( 'the_content', 'annotationspace_content_filter' );
